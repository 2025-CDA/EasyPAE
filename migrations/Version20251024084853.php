 ...
 */
final class Version20251024084853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE info_form_intern_company (id INT AUTO_INCREMENT NOT NULL, company_name VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', legal_representative_last_name VARCHAR(255) DEFAULT NULL, legal_representative_first_name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE training_session (id INT AUTO_INCREMENT NOT NULL, training_id INT DEFAULT NULL, offer_number VARCHAR(255) DEFAULT NULL, internship_period_start DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', internship_period_end DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', training_period_start DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', training_period_end DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', has_ended TINYINT(1) DEFAULT NULL, INDEX IDX_D7A45DABEFD98D1 (training_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE training_session_intern_member (training_session_id INT NOT NULL, intern_member_id INT NOT NULL, INDEX IDX_4D9FE4D8DB8156B9 (training_session_id), INDEX IDX_4D9FE4D856817849 (intern_member_id), PRIMARY KEY(training_session_id, intern_member_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, login VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', role VARCHAR(255) DEFAULT NULL, notification TINYINT(1) DEFAULT NULL, dark_mode TINYINT(1) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, birthday DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_notification (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, notification_id INT DEFAULT NULL, is_read TINYINT(1) DEFAULT NULL, is_signed TINYINT(1) DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_3F980AC8A76ED395 (user_id), INDEX IDX_3F980AC8EF1A9D84 (notification_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE training_session_intern_member ADD CONSTRAINT FK_4D9FE4D8DB8156B9 FOREIGN KEY (training_session_id) REFERENCES training_session (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE training_session_intern_member ADD CONSTRAINT FK_4D9FE4D856817849 FOREIGN KEY (intern_member_id) REFERENCES intern_member (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE training_session_intern_member DROP FOREIGN KEY FK_4D9FE4D8DB8156B9');
        $this->addSql('ALTER TABLE training_session_intern_member DROP FOREIGN KEY FK_4D9FE4D856817849');
        ...
        $this->addSql('DROP TABLE training_session_intern_member');
