...
function CircleProgress({ statusPae }) {
    ...
    const statusMap = {
        ...
        "10%": { percentage: 99, color: "#DC2626" },
        "20%": { percentage: 75, color: "#b8530a" },
        "30%": { percentage: 75, color: "#a74e0e" },
        "40%": { percentage: 75, color: "#F97316" },
        "50%": { percentage: 50, color: "#FBBF24" },
        "60%": { percentage: 50, color: "#f2c246" },
        "70%": { percentage: 50, color: "#f3ca62" },
        "80%": { percentage: 25, color: "#caf781" },
        "90%": { percentage: 25, color: "#A3E635" },
            ...
            <div className="relative">
                ...
                <div className="absolute top-1/2 start-1/2 transform -translate-y-1/2 -translate-x-1/2">
                    <span className="text-center font-medium">
                        {statusMap[statusPae] ? statusPae : "Inconnu"}
                    </span>
                </div>
            </div>
        </div>
