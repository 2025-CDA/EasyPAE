...
function SidebarItem({ icon, label, collapsed, rajout }) {
    return (
        <div className={`flex items-center gap-6 px-4 py-2 hover:bg-blue-700 rounded-lg cursor-pointer w-full${rajout ? ` ${rajout}` : ""}`}>
            <span>{icon}</span>
