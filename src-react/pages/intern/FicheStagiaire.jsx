...
const steps = [
    { title: "Stagiaire", description: "Attente d'envoi de la demande", finishedStep: 1 },
...
function FicheStagiaire({name, internNumber, email, courseName, courseNumber, trainerName, startDateInternship, endDateInternship, className, companyName, adresse, tutorEmail, tel, tutorName}) {
    ...
    return (
          ...
          <Container className={'flex flex-col border-none p-5 min-h-screen'}>
                ...
                <Container className="grid md:grid-cols-3 grid-cols-1 space-y-4 md:gap-4 px-3 py-4 border-0">
                    ...
                    <div className="col-span-2 space-y-4">
                        <CardIntern
                            name={name} internNumber={internNumber}
                            email={email}
      ...
      />
                    ...
                    <img src={BusinessMan} alt="Business-man.png" className="w-[300px] scale-x-[-1] self-end mr-30 hidden md:block" />
            </Container>
        </MainLayout>
    );
}
