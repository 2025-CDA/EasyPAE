            ...
            <div className="md:hidden flex flex-col ">
                {mobileView === 0 && (
                    <>
                        <div className='flex flex-col items-center'>
                            <h4 className='font-semibold mt-4 mb-2'>Mon compte</h4>
                            <Avatar size={'md'}/>
                            <p className='font-semibold text-sm'>{stagiaire.FirstName}</p>
                            <p className='text-secondary-text text-xs font-semibold'>{stagiaire.email}</p>
                        </div>
                        <div className='flex flex-col items-start'>
                            <h4 className='mt-15 font-semibold ml-[12.5%]'>Informations personnelles</h4>
                            <Button onClick={() => setMobileView(1)} className="w-[75%] bg-[#f2f2f2] border border-[#e0e0e0] px-4 py-2 text-primary-text ml-[12.5%] mt-2 mb-2" color="" icon={null}>
                                <div className="flex w-full items-center justify-between">
                                    <span className="flex items-center gap-4">
                                        <User className="inline-block" />
                                        <span className='font-semibold'>Editer mon profil</span>
                                    </span>
                                    <span>{'>'}</span>
                                </div>
                            </Button>
                            <Button onClick={() => setMobileView(2)} className="w-[75%] bg-[#f2f2f2] border border-[#e0e0e0] px-4 py-2 text-primary-text ml-[12.5%] mt-2 mb-2" color="" icon={null}>
                                <div className="flex w-full items-center justify-between">
                                    <span className="flex items-center gap-4">
                                        <Lock className="inline-block" />
                                        <span className='font-semibold'>Changer de mot de passe</span>
                                    </span>
                                    <span>{'>'}</span>
                                </div>
                            </Button>
                            <h4 className='mt-8 font-semibold ml-[12.5%]'>Préférences</h4>
                            <Button onClick={() => setMobileView(3)} className="w-[75%] bg-[#f2f2f2] border border-[#e0e0e0] px-4 py-2 text-primary-text ml-[12.5%] mt-2 mb-2" color="" icon={null}>
                                <div className="flex w-full items-center justify-between">
                                    <span className="flex items-center gap-4">
                                        <Heart className="inline-block" />
                                        <span className='font-semibold'>Personnaliser mon interface</span>
                                    </span>
                                    <span>{'>'}</span>
                                </div>
                            </Button>
                            <h4 className='mt-8 font-semibold ml-[12.5%]'>Plus d'informations</h4>
                            <Button onClick={() => setMobileView(4)} className="w-[75%] bg-[#f2f2f2] border border-[#e0e0e0] px-4 py-2 text-primary-text ml-[12.5%] mt-2 mb-2" color="" icon={null}>
                                <div className="flex w-full items-center justify-between">
                                    <span className="flex items-center gap-4">
                                        <User className="inline-block" />
                                        <span className='font-semibold'>A propos d'easyPAE</span>
                                    </span>
                                    <span>{'>'}</span>
                                </div>
                            </Button>
                            <Button onClick={() => setMobileView(5)} className="w-[75%] bg-[#f2f2f2] border border-[#e0e0e0] px-4 py-2 text-primary-text ml-[12.5%] mt-2 mb-2" color="" icon={null}>
                                <div className="flex w-full items-center justify-between">
                                    <span className="flex items-center gap-4">
                                        <Lock className="inline-block" />
                ...
                {mobileView === 1 && (
                    <>
                        <div className='flex items-center mb-20'>
                            <Button onClick={() => setMobileView(0)} color='' className={'text-primary-text'}>{'<'}</Button>
                            <h4 className='font-semibold m-auto'>Informations personnelles</h4>
                        </div>
                        <EditerProfile/>
                    </>
                )}
                {mobileView === 2 && (
                    <>
                        <div className='flex items-center mb-20'>
                            <Button onClick={() => setMobileView(0)} color='' className={'text-primary-text'}>{'<'}</Button>
                            <h4 className='font-semibold m-auto'>Changer de mot de passe</h4>
                        </div>
                        <UpdateMdp/>
                    </>
                )}
                {mobileView === 3 && (
                    <>
                        <div className='flex items-center mb-20'>
                            <Button onClick={() => setMobileView(0)} color='' className={'text-primary-text'}>{'<'}</Button>
                            <h4 className='font-semibold m-auto'>Préférences</h4>
                        </div>
                        <Preferences/>
                    </>
                )}
                {mobileView === 4 && (
                    <>
                        <div className='flex items-center mb-20'>
                            <Button onClick={() => setMobileView(0)} color='' className={'text-primary-text'}>{'<'}</Button>
                            <h4 className='font-semibold m-auto'>Plus d'infos</h4>
                        </div>
                        <AProposPAEeasy/>
                    </>
                )}
